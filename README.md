...
- [Production detector selection](docs/detector_selection.md)
- [Engineering limitations](docs/limitations.md)
- [Release-candidate verification](docs/RELEASE_CANDIDATE_VERIFICATION_REPORT.md)
- [Final screenshots](docs/screenshots/SCREENSHOT_INDEX.md)
...
When enabled, newly observed signal identifiers are appended to the local
runtime file `signal_log.txt`. The file is excluded from version control;
define an appropriate retention and rotation policy before long-running
collection.
