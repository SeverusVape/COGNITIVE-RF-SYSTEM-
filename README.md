...
- 138 automated regression tests passing
- Deterministic synthetic DSP validation campaign completed under
  [`VALIDATION/`](VALIDATION/)
- Routine acquisition, tuning, display, and survey operation exercised with a
  live RTL-SDR Blog V3
- Formal hardware characterization remains the next validation phase
...
using controlled numerical inputs. Live hardware characterization will address
receiver oscillator behavior, antenna-connected noise, environmental
repeatability, and recommendation repeatability.
...
[`VALIDATION/report_outputs.md`](VALIDATION/report_outputs.md) for the planned
report artifacts.
...
- Hardware operation has been exercised, but formal receiver characterization
  is not complete.
...
operation have been exercised with live hardware. A structured
hardware-characterization campaign is the next validation phase.

Planned areas:

1. **HV-FREQ-01 - receiver frequency accuracy and drift**
2. **HV-NF-01 - live receiver noise-floor behavior**
3. **HV-OCC-01 - live occupancy repeatability**
4. **HV-SMART-01 - recommendation repeatability**
